...
export const TAG_SCHEMAS = {
  ...
  'set-counter':  { label: 'Set Counter', desc: 'Set a world-scoped counter to a specific value on consequence fire. Optional third field targets an external event\'s counter.', repeatable: true, fields: [{ name: 'name', type: 'text', required: true, placeholder: 'counter-name' }, { name: 'value', type: 'text', required: true, placeholder: '0' }, { name: 'ref', type: 'event-ref', required: false, placeholder: 'external event (optional)' }] },
...
export const TAGS_BY_EVENT_TYPE = {
  ...
  consequence: ['respawn', 'clears', 'give-item', 'consume-item', 'deal-damage', 'set-state', 'set-counter', 'requires', 'requires-not', 'transition-effect', 'transition-duration', 'transition-clear', 'content-type', 'sound'],
